  ...
  async function savePlace(ev) {
    ...
    try {
      if (id) {
        ...
        console.log('✅ Updated place:', res.data);
      } else {
        const res = await api.post('/places', placeData);
        console.log('✅ Created place:', res.data);
      }
      setRedirect(true);
    } catch (err) {
  ...
  return (
    <div>
      ...
      <form onSubmit={savePlace}>
        ...
        {preInput('Check in & out times', 'Add times and make sure there’s a window for cleaning between guests')}
